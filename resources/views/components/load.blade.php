...
top: 0px ;left:0px; z-index:9999; width: 100%; height:100%; background:rgb(167, 160, 160); opacity: .75;">
    <div style="color: #ffffff" class="la-ball-scale-ripple-multiple la-2x">
        <div></div>
        <div></div>
        <div></div>
    </div>
