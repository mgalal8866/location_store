                        ...
                        <div class="tab-pane fade" id="custom-tabs-five-normal" role="tabpanel"
                            aria-labelledby="custom-tabs-five-normal-tab" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="application_name" placeholder="اسم التطبيق" value="ALMakhzakhana - المخزخانة" dir="rtl">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">عنوان الموقع</label>
                                    <input type="text" class="form-control" name="site_title" placeholder="عنوان الموقع" value="ALMakhzakhana - المخزخانة" dir="rtl">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">عنوان الصفحة الرئيسية</label>
                                    <input type="text" class="form-control" name="homepage_title" placeholder="عنوان الصفحة الرئيسية" value="الرئيسية" dir="rtl">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">وصف الموقع</label>
                                    <input type="text" class="form-control" name="site_description" placeholder="وصف الموقع" value="ALMakhzakhana - المخزخانة" dir="rtl">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">الكلمات الدالة</label>
                                    <input type="text" class="form-control" name="keywords" placeholder="الكلمات الدالة" value="ALMakhzakhana - المخزخانة" dir="rtl">
                                </div>

                                <div class="form-group">
                                    <label class="control-label">حقوق النشر</label>
                                    <input type="text" class="form-control" name="copyright" placeholder="حقوق النشر" value=".Copyright 2022 ALMakhzakhana - Powered By: MIsmaiel Group All Rights Reserved" dir="rtl">
                                </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">جوجل reCAPTCHA</h3>
                                            </div>
                                            <!-- /.box-header -->

                                            <!-- form start -->
                                            <form action="https://almakhzakhana.com/admin_controller/recaptcha_settings_post" method="post" accept-charset="utf-8">
                                <input type="hidden" name="csrf_mds_token" value="095985a620405905c7d81256317c1c7d">
                                            <div class="box-body">
                                                <!-- include message block -->
                                                                <div class="form-group">
                                                    <label class="control-label">مفتاح الموقع</label>
                                                    <input type="text" class="form-control" name="recaptcha_site_key" placeholder="مفتاح الموقع" value="" dir="rtl">
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">المفتاح السري</label>
                                                    <input type="text" class="form-control" name="recaptcha_secret_key" placeholder="المفتاح السري" value="" dir="rtl">
                                                </div>

                                                <div class="form-group">
                                                    <label class="control-label">اللغة</label>
                                                    <input type="text" class="form-control" name="recaptcha_lang" placeholder="اللغة" value="en" dir="rtl">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="box box-primary">
                                            <div class="box-header with-border">
                                                <h3 class="box-title">نمط الصيانة</h3>
                                            </div>
                                            <!-- /.box-header -->

                                            <!-- form start -->
                                            <form action="https://almakhzakhana.com/admin_controller/maintenance_mode_post" method="post" accept-charset="utf-8">
                                <input type="hidden" name="csrf_mds_token" value="095985a620405905c7d81256317c1c7d">
                                            <div class="box-body">
                                                <!-- include message block -->
                                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-4 col-xs-12 col-option">
                                                            <div class="iradio_square-purple" style="position: relative;" aria-checked="false" aria-disabled="false"><input type="radio" name="maintenance_mode_status" value="1" id="maintenance_mode_status_1" class="square-purple" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div>
                                                            <label for="maintenance_mode_status_1" class="option-label">تفعيل</label>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-12 col-option">
                                                            <div class="iradio_square-purple checked" style="position: relative;" aria-checked="false" aria-disabled="false"><input type="radio" name="maintenance_mode_status" value="0" id="maintenance_mode_status_2" class="square-purple" checked="" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: -20%; left: -20%; display: block; width: 140%; height: 140%; margin: 0px; padding: 0px; background: rgb(255, 255, 255) none repeat scroll 0% 0%; border: 0px none; opacity: 0;"></ins></div>
                                                            <label for="maintenance_mode_status_2" class="option-label">إبطال</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
