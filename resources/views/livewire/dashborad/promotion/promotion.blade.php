    ...
    <div wire:ignore.self id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary close-btn" data-dismiss="modal">Close</button>
                    <button type="button" wire:click.prevent="edit()" class="btn btn-success close-modal" data-dismiss="modal">{{__('save')}}</button>
                </div>
            </div>
        </div>
    </div>
    <div wire:ignore.self id="modal-create" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="CreateModalLabel">Create Promotion</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                         <span aria-hidden="true close-btn">×</span>
                    </button>
                </div>
                ...
                <tbody>
                    @forelse ( $promotionview as $prom )
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-warning btn-sm" data-toggle="modal"  data-target="#modal-edit"  wire:click.prevent="view('{{$prom->id}}')"><i class="far fa-eye"></i>  {{ __('tran.edit') }}  </button>
